...
def coarsen(A, levels, self_connections=False):
    ...
    Transposed from "Defferrard, Bresson, Vandergheynst, Convolutional Neural Networks on Graphs with Fast Localized Spectral Filtering, NIPS, 2016".
    Source: https://github.com/mdeff/cnn_graph
    License: MIT
    """
...
def perm_adjacency(A, indices):
    ...
    assert isinstance(A, sp.sparse.coo.coo_matrix)
    return A
